...
namespace PianoRoll.Themes
{
    ...
    {
        public static SolidColorBrush blackNoteChannelBrush = new SolidColorBrush((Color)ColorConverter.ConvertFromString("#e2e0df"));
        public static SolidColorBrush noteSeparatorBrush = new SolidColorBrush((Color)ColorConverter.ConvertFromString("#c9cac9"));
        ...
        public static SolidColorBrush foreBrush = new SolidColorBrush((Color)ColorConverter.ConvertFromString("#90FFFF"));
